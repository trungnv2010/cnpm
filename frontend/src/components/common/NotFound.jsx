  ...
  <>
    <div class="bg-gray-200 flex items-center justify-center h-screen">
      <div class="text-center">
        ...
        <Link to="/" class="mt-6 inline-block px-6 py-3 text-white font-medium bg-yellow-500 rounded hover:bg-blue-700 transition duration-300 ease-in-out">Trở về trang chủ</Link>
      </div>
    </div>
  </>
  )
